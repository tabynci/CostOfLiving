...
function Navbar(props) {
  ...
  useEffect(function(){
    ...
    //         </li>
    //         <li className="nav-item ">
    //           <a className="nav-link  active item-font" aria-current="page" href="/Register">Register</a>
    //         </li>
            
    //         <li className="nav-item">
    //           <a className="nav-link  active item-font" aria-current="page" href="/Login">Login</a>
    //         </li>
    //         <li className="nav-item">
    ...
    //             Dropdown
    //           </a>
    //           <ul className="dropdown-menu item-font">
    ...
    //         <button className="btn btn-outline-success item-font" type="submit">Search</button>
    //       </form> */}
    //     </div>
    //   </div>
    // </nav>
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
            <a className="nav-link active" aria-current="page" href="/AdminDashboard">AdminDashbaord</a>
          </li>
          <li className="nav-item">
